...
namespace BoGK.GameSystem
{
	public partial class LocalizationController
	{
		...
		private Dictionary<string, Gameplay.Breakable> _breakables = new Dictionary<string, Gameplay.Breakable>
		{
			{"block_health", (Gameplay.Breakable)ResourceLoader.Load<PackedScene>("res://prefabs/blocks/block_basic.tscn").Instantiate()},
			{"block_sturdy_health", (Gameplay.Breakable)ResourceLoader.Load<PackedScene>("res://prefabs/blocks/block_sturdy.tscn").Instantiate()},
			{"barrier_sturdy_health", (Gameplay.Breakable)ResourceLoader.Load<PackedScene>("res://prefabs/blocks/barrier_sturdy.tscn").Instantiate()}
		};
